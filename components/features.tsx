...
const features: Feature[] = [
  {
    ...
    icon: <FastForward className="w-8 h-8 text-sand-500" aria-hidden="true" />,
  },
  {
    title: "Secure",
    description: "Top-notch security to protect your assets.",
    icon: <Lock className="w-8 h-8 text-sand-500" aria-hidden="true" />,
  },
  {
    title: "Low Fees",
    description: "Enjoy minimal transaction fees on every transaction.",
    icon: <DollarSign className="w-8 h-8 text-sand-500" aria-hidden="true" />,
  },
  {
    title: "User-Friendly",
    description: "An intuitive interface for all your NFT needs.",
    icon: <LaptopMinimal className="w-8 h-8 text-sand-500" aria-hidden="true" />,
  },
];
